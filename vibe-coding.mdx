...
The Vibe Coding Block is currently in beta and free to use. Once the beta period ends, the block will use AI credits. A certain number of monthly credits is available on each plan (including Free). Learn more about AI credits [here](https://docs.softr.io/workspace-and-billing/ai-credits).