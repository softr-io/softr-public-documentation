...
### 3. Add and configure functionalities (optional)

You can prompt the AI to add functionality to your block, such as:
...
2. Review each item and configure permissions, conditions, or connected workflows as needed
