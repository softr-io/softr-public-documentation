...
<Frame>![Notion image](/add-and-manage-users/images/users-menu/image1.png)</Frame>
...
<Frame>![Notion image](/add-and-manage-users/images/users-menu/image2.png)</Frame>
...
<Frame>![Notion image](/add-and-manage-users/images/users-menu/image3.png)</Frame>
...
<Frame caption="Generate magic link">![Generate magic link](/add-and-manage-users/images/users-menu/image4.png)</Frame>

### **Copy magic link**

After generating the link, you can copy it using the copy button.
<Frame caption="Copying the link">![Copying the link](/add-and-manage-users/images/users-menu/image5.png)</Frame>

### **Regenerate magic link**

You can regenerate any user's **Magic Link** at any time using the regenerate button as shown below.
<Frame caption="Regenerating the link">![Regenerating the link](/add-and-manage-users/images/users-menu/image6.png)</Frame>

### Delete a Magic Link

You can also revoke/delete a magic link by clicking on the trash can icon:
<Frame caption="Delete a magic link using the trash can icon">![Delete a magic link using the trash can icon](/add-and-manage-users/images/users-menu/image7.png)</Frame>
