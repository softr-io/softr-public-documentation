...
* [Hero](/building-blocks/static-blocks#hero): Used as a headline or introductory banner for a page.

* **FAQ**: Displays frequently asked questions and answers.

* [CTA (Call to Action):](/building-blocks/static-blocks#cta) Encourages users to take specific actions, like signing up or contacting support.
