...
* **Non Logged in users**
<Frame caption="Visibility options">![Visibility options](/user-groups-and-permissions/images/block-visibility/image1.png)</Frame>
...
<Frame caption="Padlock icon indicating limited visibility">![Padlock icon indicating limited visibility](/user-groups-and-permissions/images/block-visibility/image2.png)</Frame>
...
<Frame caption="Device visibility options">![Device visibility options](/user-groups-and-permissions/images/block-visibility/image3.png)</Frame>
...
<Frame caption="Applying device visibility">![Applying device visibility](/user-groups-and-permissions/images/block-visibility/image4.png)</Frame>
...
- [How to Make Pages/Blocks Accessible Only to Company Users?](/how-to-guides/how-to-make-pagesblocks-accessible-only-to-company-users)
