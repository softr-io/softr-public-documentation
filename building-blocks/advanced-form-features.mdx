...
<Frame caption="Form destination">![Form destination](/building-blocks/images/advanced-form-features/image1.png)</Frame>
...
### **Success Message**
<Frame caption="Configuring the success message">![Configuring the success message](/building-blocks/images/advanced-form-features/image2.png)</Frame>

You can customize the message as well as configure styling and formatting.

### **Open Page**
<Frame caption="“Open Page” option">![“Open Page” option](/building-blocks/images/advanced-form-features/image3.png)</Frame>

Just select the page, and the user will be taken there after successful submission.

## Field settings
<Frame caption="Field settings">![Field settings](/building-blocks/images/advanced-form-features/image4.png)</Frame>
...
* **DateTime** – allows providing date and time within a single field. Can be mapped to any text type field in Airtable (e.g. Single Line Text)
  <Frame caption="DateTime field">![DateTime field](/building-blocks/images/advanced-form-features/image5.png)</Frame>
...
* **Dropdown** – a dropdown where users can select one of the provided options. Here, you also have the **Options** parameter, where you can list all the options separated by a semicolon (**without spacing**).
  <Frame caption="Dropdown field type">![Dropdown field type](/building-blocks/images/advanced-form-features/image6.png)</Frame>
...
<Frame caption="“Sync options with data source” toggle">![“Sync options with data source” toggle](/building-blocks/images/advanced-form-features/image7.png)</Frame>
...
<Frame>![Notion image](/building-blocks/images/advanced-form-features/image8.png)</Frame>
...
<Frame caption="Signature field selection and draw or type option modals">![Signature field selection and draw or type option modals](/building-blocks/images/advanced-form-features/image9.png)</Frame>
...
### Hidden field
<Frame caption="Hidden field settings">![Hidden field settings](/building-blocks/images/advanced-form-features/image10.png)</Frame>
...
<Frame caption="Users Base on Airtable">![Users Base on Airtable](/building-blocks/images/advanced-form-features/image11.png)</Frame>
...
<Frame caption="Text field settings">![Text field settings](/building-blocks/images/advanced-form-features/image12.png)</Frame>
...
<Frame caption="Prefilling the name field">![Prefilling the name field](/building-blocks/images/advanced-form-features/image13.gif)</Frame>
...
<Frame caption="reCaptcha setup">![reCaptcha setup](/building-blocks/images/advanced-form-features/image14.png)</Frame>

In the next screen, you just need to copy the **Site Key** and **Secret Key.**
<Frame caption="Getting Site Key and Secret Key">![Getting Site Key and Secret Key](/building-blocks/images/advanced-form-features/image15.png)</Frame>

To finalize the setup, paste the Site Key and Secret Key in your Softr app's **Settings => Integrations => Google reCaptcha.**
<Frame caption="Adding reCaptcha keys">![Adding reCaptcha keys](/building-blocks/images/advanced-form-features/image16.png)</Frame>
