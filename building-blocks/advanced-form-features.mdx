...
<Frame caption="Form destination">
  ![Form destination](/building-blocks/images/advanced-form-features/image1.png)
</Frame>
...
<Frame caption="Configuring the success message">
  ![Configuring the success message](/building-blocks/images/advanced-form-features/image2.png)
</Frame>
...
<Frame caption="“Open Page” option">
  ![“Open Page” option](/building-blocks/images/advanced-form-features/image3.png)
</Frame>
...
<Frame caption="Field settings">
  ![Field settings](/building-blocks/images/advanced-form-features/image4.png)
</Frame>
...
- **DateTime** – allows providing date and time within a single field. Can be mapped to any text type field in Airtable (e.g. Single Line Text)
  <Frame caption="DateTime field">
    ![DateTime field](/building-blocks/images/advanced-form-features/image5.png)
  </Frame>
...
- **Dropdown** – a dropdown where users can select one of the provided options. Here, you also have the **Options** parameter, where you can list all the options separated by a semicolon (**without spacing**).
  <Frame caption="Dropdown field type">
    ![Dropdown field type](/building-blocks/images/advanced-form-features/image6.png)
  </Frame>
...
<Frame caption="“Sync options with data source” toggle">
  ![“Sync options with data source” toggle](/building-blocks/images/advanced-form-features/image7.png)
</Frame>
...
<Frame>
  ![Notion image](/building-blocks/images/advanced-form-features/image8.png)
</Frame>
...
<Frame caption="Signature field selection and draw or type option modals">
  ![Signature field selection and draw or type option modals](/building-blocks/images/advanced-form-features/image9.png)
</Frame>
...
<Frame caption="Hidden field settings">
  ![Hidden field settings](/building-blocks/images/advanced-form-features/image10.png)
</Frame>
...
<Frame caption="Users Base on Airtable">
  ![Users Base on Airtable](/building-blocks/images/advanced-form-features/image11.png)
</Frame>
...
<Frame caption="Text field settings">
  ![Text field settings](/building-blocks/images/advanced-form-features/image12.png)
</Frame>
...
<Frame caption="Prefilling the name field">
  ![Prefilling the name field](/building-blocks/images/advanced-form-features/image13.gif)
</Frame>
...
> **?prefill_NAME=John&prefill_Email=[john@softr.io](mailto:john@softr.io)**

Now, let's see how prefill works for the field types that receive their values differently.

### **Multi-select Dropdown**

Here, list all the preselected values in a **single** parameter, separated by semicolons with no spaces:

> **prefill_Option=X;Y**

<Frame caption="A multi-select field prefilled with two values from the URL.">
  ![A Softr form field labelled Skills showing two selected chips, Design and Research, both applied from the page URL](/building-blocks/images/advanced-form-features/prefill-multiselect.png)
</Frame>

<Warning>
  The semicolon is the only separator that works. A comma (**prefill_Option=X,Y**) matches no option and leaves the field empty, and repeating the parameter (**prefill_Option=X&prefill_Option=Y**) applies only the last value. A space after the semicolon (**X; Y**) silently drops everything after it.
</Warning>

<Note>
  Prefilling more than one value also needs the form field itself to accept more than one. In the block’s **Steps** tab, open the field, expand **Selection**, and switch on **Allow multi-select** — otherwise only the first value in the list is applied.
</Note>
...
> **?prefill_datefield=dd/mm/yyyy**<br /> **?prefill_datetimefield=mm-dd-yy HH:MM**
...
To set up reCaptcha, you need to go to [https://www.google.com/recaptcha/admin/create](https://www.google.com/recaptcha/admin/create) and enter your site details as shown below.

<Frame caption="reCaptcha setup">
  ![reCaptcha setup](/building-blocks/images/advanced-form-features/image14.png)
</Frame>

In the next screen, you just need to copy the **Site Key** and **Secret Key.**

<Frame caption="Getting Site Key and Secret Key">
  ![Getting Site Key and Secret Key](/building-blocks/images/advanced-form-features/image15.png)
</Frame>
...
<Frame caption="Adding reCaptcha keys">
  ![Adding reCaptcha keys](/building-blocks/images/advanced-form-features/image16.png)
</Frame>
