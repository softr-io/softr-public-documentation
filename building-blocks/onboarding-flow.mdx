...
You can create as many onboarding flows as needed—each one will be treated as its own dedicated utility page. Every app must have at least one onboarding flow. <Frame>
  ![Notion image](/building-blocks/images/onboarding-flow/image1.png)
</Frame>
...
- Link to the relevant **data source** and **table** (if applicable) <Frame>
    ![Notion image](/building-blocks/images/onboarding-flow/image2.png)
  </Frame>
...
- Choose what happens when onboarding is complete (e.g. redirect to dashboard, thank-you page, or other app page) <Frame>
    ![Notion image](/building-blocks/images/onboarding-flow/image3.png)
  </Frame>
...
<Frame>
  ![Notion image](/building-blocks/images/onboarding-flow/image4.png)
</Frame>

---

<Frame>
  ![Notion image](/building-blocks/images/onboarding-flow/image5.png)
</Frame>
...
- You can also manually:
  ...
  - **Mark onboarding as completed** if needed <Frame>
      ![Notion image](/building-blocks/images/onboarding-flow/image6.png)
    </Frame>
