...
- _"When a new Deal is moved to 'Closed Won' in the CRM, send a Slack message and trigger a congratulatory email."_
- _"Every Monday morning, find all tasks that are overdue and email a summary to the manager."_
...
### **Do unused Workflow actions rollover?**

No, unused workflow actions do not rollover from one month to the next, however, the workflow action monthly limit is reset back to your full plan allowance.
