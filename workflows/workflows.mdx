...
<Steps>
  <Step title="Create a new Workflow">
    ...
    Note: You can use the AI Co-builder right away in the visual builder after you select a trigger or a template. Click the AI icon in the bottom right, describe what you’re trying to build, and it will generate an editable outline (trigger, actions, and logic). These queries don’t consume AI credits. <Frame>
      ![Notion image](/workflows/images/workflows/image1.png)
    </Frame>

    ---

    <Frame>
      ![Notion image](/workflows/images/workflows/image2.png)
    </Frame>
  </Step>
  <Step title="Select a trigger">
    ...
    **Note:** Triggers can reference your Softr app and Database directly—no external connectors required. <Frame>
      ![Notion image](/workflows/images/workflows/image3.png)
    </Frame>
  </Step>
  <Step title="Add actions">
    ...
    Note: AI-based actions using Softr’s built-in LLM integrations (for example, summarizing text or enriching data) use **AI credits**. Learn more about AI credits → <Frame>
      ![Notion image](/workflows/images/workflows/image4.png)
    </Frame>
  </Step>
  <Step title="Add settings and conditions">
    ...
    - **For logic steps:** define conditions in **Filters/Branches** or **Wait** times. <Frame>
        ![Notion image](/workflows/images/workflows/image5.png)
      </Frame>
  </Step>
...
When building your workflow, click the AI icon in the bottom right (above the chat icon) to describe what you’re trying to build. The AI Co-builder creates a sample workflow; you can modify triggers, actions, and logic before turning it on. <Frame>
  ![Notion image](/workflows/images/workflows/image7.png)
</Frame>
...
Note: Wait/progress screens apply to app-triggered workflows (not Database/scheduled triggers). <Frame>
  ![Notion image](/workflows/images/workflows/image8.png)
</Frame>
