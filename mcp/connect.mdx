...
Pick your tool below. Every route ends on the same Softr authorization screen — see [What you are approving](#what-you-are-approving).
...
<Tabs>
  <Tab title="Claude">
    ...
    <Steps>
      ...
      <Step title="Authorize your Softr account">
        Click **Connect**, choose what Claude can reach, and click **Allow**.
      </Step>
      <Step title="Try it">
  ...
  <Tab title="Claude Code">
    ...
    <Steps>
      ...
      <Step title="Authenticate">
        Run `/mcp` inside Claude Code, select **softr** and choose **Authenticate**. Softr's authorization screen opens in your browser.
  ...
  <Tab title="ChatGPT">
    Softr is in ChatGPT's plugin directory, so there is no server URL to paste and no developer mode to switch on.

    <Steps>
      <Step title="Add the Softr plugin">
        Open [Softr in ChatGPT's plugin directory](https://chatgpt.com/plugins/plugin_asdk_app_6aa42fc7bb8c8191a23a2979f3b05e44) and click **Connect**.

        <Frame caption="Softr's page in ChatGPT's plugin directory. Connect starts the authorization.">
          ![Softr's plugin page in ChatGPT with the Connect button](/images/connect/chatgpt-softr-plugin.png)
        </Frame>
      </Step>
      <Step title="Authorize your Softr account">
        Choose what ChatGPT can reach, and click **Allow**.
      </Step>
      <Step title="Try it">
        Start a new chat and ask _"List my Softr apps."_
      </Step>
  ...
  <Tab title="Codex">
    ...
    <Steps>
      ...
      <Step title="Sign in">
        ...
        Softr's authorization screen opens in your browser. Run `codex mcp list` to confirm the server is there, or `/mcp` in the Codex TUI.
      </Step>
      <Step title="Try it">
  ...
  <Tab title="Cursor">
    <Steps>
      ...
      <Step title="Authorize your Softr account">
        Softr appears under **Needs Attention**. Click **Authenticate**, choose what Cursor can reach, and click **Allow**.
  ...
  <Tab title="Other MCP clients">
    ...
    <Steps>
      ...
      <Step title="Authorize your Softr account">
        Follow the client's sign-in flow, choose what it can reach, and click **Allow**.
      </Step>
    </Steps>
  </Tab>
</Tabs>
