...
| [Applications](/mcp/apps) | Create a blank app; read apps, pages, blocks, and permissions; add and remove app users; enable or disable login; preview an app; publish it |
