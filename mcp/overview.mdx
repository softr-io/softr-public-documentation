...
| [Applications](/mcp/apps) | Create a blank app; add pages; read apps, pages, blocks, and permissions; list, search, add, remove, activate, and deactivate app users; enable or disable login; configure sign-up and the email sender; preview an app; publish it |
