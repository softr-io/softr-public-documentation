...
| [Applications](/mcp/apps) | Create a blank app; add pages; read apps, pages, blocks, and permissions; list, search, add, remove, activate, and deactivate app users; enable or disable login; configure sign-up, the email sender, and the app's subdomain and custom domain; preview an app; publish it |
...
|---|---|---|
| Applications & Forms | Read only | Read apps, pages, blocks, user groups, permissions, and the fields of the table that authenticates end users; browse integrations |
| | Full access | The above, plus adding pages, creating and editing vibe coding blocks, creating, changing, and deleting user groups, previewing, and publishing |
...
- _"Change my app's subdomain to my-crm.softr.app."_
- _"Connect app.acme.com to my app."_
- _"List my app's users — who hasn't signed in yet?"_
