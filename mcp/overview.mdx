...
| [Applications](/mcp/apps) | Create a blank app; add pages; read apps, pages, blocks, and permissions; add and remove app users; enable or disable login; configure sign-up; preview an app; publish it |
