...
description: "Let an AI assistant create blank apps, add pages, read your apps, manage their users, toggle login, configure sign-up, preview changes, and publish them."
'og:title': "MCP: Applications – Softr Help Docs"
'og:description': "Let an AI assistant create blank apps, add pages, read your apps, manage their users, toggle login, configure sign-up, preview changes, and publish them."
...
'twitter:description': "Let an AI assistant create blank apps, add pages, read your apps, manage their users, toggle login, configure sign-up, preview changes, and publish them."
icon: "window"
---
