...
<Frame caption="Custom Code block">
...
<Frame caption="Selecting 'Add to Your Website'">
...
<Frame caption="Choosing 'Inline Embed'">
...
<Frame caption="Copying the Calendly page code">
...
<Frame caption="Applying the code">
