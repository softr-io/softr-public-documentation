...
<Note>
  ...
  Server](/mcp/overview), which is for **you as the builder** — it reaches your
  whole workspace, including its databases, apps, and workflows. The **App MCP
  Server** is for **your app's users**, is scoped to a single published app,
  uses that app's domain, and has its own OAuth credentials.
</Note>
