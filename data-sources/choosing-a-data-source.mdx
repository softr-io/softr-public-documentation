...
- **Connecting your current source**: If you prefer to keep your data where it is, Softr connects natively to over 20 different data sources. This is a great option if you already have complex workflows or other tools connected to your data.
...
| SQL (PostgreSQL, MySQL, SQL Server, MariaDB) | Unlimited | Unlimited | High | High | \$ |
...
| Snowflake | Unlimited | N/A | High | High | \$\$\$ |
| Microsoft Excel | Up to 500,000 | 50-100 | Low | Low | \$ |
| Zoho CRM | 1 million + | 200-300 | Medium | Medium | \$\$ |
| Baserow | Up to 500,000 | 200-300 | Medium | Low | \$ |

<Note>
  Reading down the table, **Softr Databases** is the only option that pairs unlimited concurrent users with low setup effort — and, because it is native to the platform, it has no external API rate limits to throttle your app. Each external source gives up at least one of those: spreadsheets and project tools cap out on concurrency, warehouses and SQL need real technical setup, and CRMs get expensive quickly. If your data does not already live somewhere, [start with Softr Databases](/softr-databases/softr-databases-overview).
</Note>
