...
<Steps>
  <Step title="Connect Coda to Softr">
    ...
    2. **Access Data Sources**:<br/>
       ...
       * Click **Connect Data Source**<Frame>![Notion image](/data-sources/images/coda/image1.png)</Frame>
       * Select **Coda** from the list of available integrations, then click **Continue**.<Frame>![Notion image](/data-sources/images/coda/image2.png)</Frame>

    3. **Authenticate with Coda**:<br/>
       * You’ll be prompted to provide an API token.<Frame>![Notion image](/data-sources/images/coda/image3.png)</Frame>
    ...
    4. **Manage the Coda Connection**<br/>
       ...
       * Click on **See Active Apps** to see a list of all the Softr apps the connection is being used in.<Frame>![Notion image](/data-sources/images/coda/image4.png)</Frame>
  </Step>
  <Step title="Configure Data Mapping">
    ...
    2. **Choose Document and Table**:<br/>
       ...
       * Choose the Document and table in the document you want to map to the block.<Frame>![Notion image](/data-sources/images/coda/image5.png)</Frame>

    3. **Apply Filters and Conditions** (Optional):<br/>
       * Use Softr’s filtering options to display specific rows from your Coda table based on conditions (e.g., show only tasks assigned to a specific user).<Frame>![Notion image](/data-sources/images/coda/image6.png)</Frame>
       * Set visibility rules to control which data is shown to different user roles. For example, click on the **Visibility** tab to control who can see the entire block. You can also do this for buttons in the **Actions** tab as well.<Frame>![Notion image](/data-sources/images/coda/image7.png)</Frame>
    ...
    4. **Map Columns to Fields in Softr:**<br/>
       ...
       * Softr supports Coda’s table columns, including text, numbers, dates, select lists, and attachments.<Frame>![Notion image](/data-sources/images/coda/image8.png)</Frame>
  </Step>
  ...
  <Step title="Test and Publish">
    1. **Preview Your App**:<br/>
       ...
       * Verify that filters, permissions, and sync settings work as expected.<Frame>![Notion image](/data-sources/images/coda/image9.png)</Frame>
    ...
    2. **Publish Your App**:<br/>
       ...
       * Share the app with users via a [custom domain](/publishing/9qTmU2Lj8Gnpr1Ue6dEAkX/add-a-custom-domain-to-your-app/93K5bLJN3n91MRo9uRGdAf), public link, or restricted access for logged-in users.<Frame>![Notion image](/data-sources/images/coda/image10.png)</Frame>
  </Step>
</Steps>
