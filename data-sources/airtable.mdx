...
<Steps>
  <Step title="Add an Airtable data source to your workspace">
    In your [Softr Dashboard](https://studio.softr.io/dashboard/data-sources), navigate to **Data Sources** in the left menu and click **Connect Data Source.** Select **Airtable** and proceed to authenticate your account. <Frame caption="Add, edit, or remove a datasource using the buttons on the dashboard">
      ![Add, edit, or remove a datasource using the buttons on the dashboard](/data-sources/images/airtable/image1.png)
    </Frame>
  </Step>
  <Step title="Grant access to the Airtable bases you want to use in your workspace.">
    ...
    <Frame caption="Granting access to Airtable bases">
      ![Granting access to Airtable bases](/data-sources/images/airtable/image2.png)
    </Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="Connect your data to a dynamic block">
    ...
    <Frame caption="Selecting an Airtable view in Softr">
      ![Selecting an Airtable view in Softr](/data-sources/images/airtable/image3.png)
    </Frame>
    <Info>
  ...
  <Step title="Map Airtable columns to item fields">
    ...
    **Example:** If your Airtable base has a **Profile Picture (Attachment field)**, map it to an **Image field** in Softr so it displays correctly. <Frame caption="Airtable fields">
      ![Airtable fields](/data-sources/images/airtable/image4.png)
    </Frame>
    <Frame caption="Mapping an image field">
      ![Mapping an image field](/data-sources/images/airtable/image5.png)
    </Frame>
...
<AccordionGroup>
  ...
  <Accordion title="How can I improve my app's performance?">
    ...
    If you have already authenticated your Airtable account, click **"Switch to personal access token"** below the data source name and paste your Airtable PAT. <Frame>
      ![Notion image](/data-sources/images/airtable/image6.png)
    </Frame>
