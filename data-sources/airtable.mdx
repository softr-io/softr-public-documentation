...
<Steps>
  <Step title="Add an Airtable data source to your workspace">
    ...
    <Frame caption="Add, edit, or remove a datasource using the buttons on the dashboard">![Add, edit, or remove a datasource using the buttons on the dashboard](/data-sources/images/airtable/image1.png)</Frame>
  </Step>
  <Step title="Grant access to the Airtable bases you want to use in your workspace.">
    ...
    <Frame caption="Granting access to Airtable bases">![Granting access to Airtable bases](/data-sources/images/airtable/image2.png)</Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="Connect your data to a dynamic block">
    ...
    **Important:** Each Airtable table can only connect to one Softr block. For example, if you want to display **Projects** in a List block, you’ll need to map it to the **Projects table** in your base. If you also want to show **Tasks**, you’ll need to add a separate block and connect it to the **Tasks table**.
    ...
    <Frame caption="Selecting an Airtable view in Softr">![Selecting an Airtable view in Softr](/data-sources/images/airtable/image3.png)</Frame>
    <Info>
  ...
  <Step title="Map Airtable columns to item fields">
    ...
    **Example:** If your Airtable base has a **Profile Picture (Attachment field)**, map it to an **Image field** in Softr so it displays correctly.
    <Frame caption="Airtable fields">![Airtable fields](/data-sources/images/airtable/image4.png)</Frame><Frame caption="Mapping an image field">![Mapping an image field](/data-sources/images/airtable/image5.png)</Frame>
    <Info>
...
<Frame>![Notion image](/data-sources/images/airtable/image6.png)</Frame>
