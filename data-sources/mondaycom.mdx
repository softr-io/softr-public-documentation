...
<Steps>
  <Step title="Get your API token">
    ...
    * Copy your **Personal API Token**.
      <Frame>![Notion image](/data-sources/images/mondaycom/image1.png)</Frame>
  </Step>
  <Step title="Add monday.com as a data source in Softr">
    ...
    * Select **monday.com** and paste your API token.
    <Frame>![Notion image](/data-sources/images/mondaycom/image2.png)</Frame>
  </Step>
</Steps>
...
<Steps>
  <Step title="Connect your data to a dynamic block">
    ...
    **Important:** You can connect **only one board to one block**. For example, if you want to show a list of clients, you can select the **Companies** board. If you would like to show **Tickets**, you will need to add another **dynamic block.**
    ...
    <Frame>![Notion image](/data-sources/images/mondaycom/image3.png)</Frame>
  </Step>
  <Step title="Map monday.com columns to item fields">
    ...
    **Example:** If your Airtable base has a **Profile Picture (Attachment field)**, map it to an **Image field** in Softr so it displays correctly
    <Frame>![Notion image](/data-sources/images/mondaycom/image4.png)</Frame><Frame caption="Mapping an image field">![Mapping an image field](/data-sources/images/mondaycom/image5.png)</Frame>
...
<Frame caption="monday.com Projects board with a Connected board with Clients.">![monday.com Projects board with a Connected board with Clients.](/data-sources/images/mondaycom/image6.png)</Frame>
...
<Frame caption="monday.com Clients board with a Connected board with Projects.">![monday.com Clients board with a Connected board with Projects.](/data-sources/images/mondaycom/image7.png)</Frame>
