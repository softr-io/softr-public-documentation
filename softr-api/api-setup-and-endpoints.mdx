...
Just replace **user@softr.io** with the actual email of the user you need to deactivate as well as provide your API key (the value next to **Softr-Api-Key**) and the domain/subdomain of the Softr app (the value next to **Softr-Domain**) you want to deactivate the user in. **The rest needs to remain the same as in the example.**
...
Just replace **user@softr.io** with the actual email of the user you need to activate as well as provide your API key (the value next to **Softr-Api-Key**) and the domain/subdomain of the Softr app (the value next to **Softr-Domain**) you want to activate the user in. **The rest needs to remain the same as in the example.**
...
Just replace **user@softr.io** with the actual email of the user you need to invite as well as provide your API key (the value next to **Softr-Api-Key**) and the domain/subdomain of the Softr app (the value next to **Softr-Domain**) you want to invite the user in. **The rest needs to remain the same as in the example.**
