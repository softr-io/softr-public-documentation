...
Rounds a number to the nearest multiple of the given number. It rounds up or down, whichever multiple is closer.
...
If Revenue is 93291.13, the result is 93000.

```plain
MROUND({Price}, 0.05)
```

If Price is 2.34, the result is 2.35.
