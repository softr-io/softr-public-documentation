...
If you’re using another block type that doesn’t have a link option for text, you can simply add an **HTML {"<a>"} tag** inside the text. The following screenshot illustrates this on the example of a [Hero block](/building-blocks/static-blocks#hero).
