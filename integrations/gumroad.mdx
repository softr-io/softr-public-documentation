...
Alternatively, you can add the link directly if the product is a standalone item (e.g. you are using a [CTA button](/building-blocks/static-blocks#cta)), as shown in the example below.
