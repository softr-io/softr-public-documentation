...
| AI Tool | Integration |
|---|---|
| Claude (claude.ai) | Connect directly from Claude's MCP settings |
| Cursor | Connect directly from Cursor's MCP settings |
| ChatGPT | Connect directly from ChatGPT's connector settings |
| Mistral AI | Connect directly from Mistral AI's settings |
...
|---|---|---|
| `list_databases` | List all databases in your workspace, including name, description, table count, and timestamps. | `databases.records:read` |
| `get_database` | Get details of a specific database by ID. | `databases.records:read` |
