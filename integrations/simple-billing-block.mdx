...
As soon as you're done with Stripe integration, you can proceed with setting up a [Pricing](/building-blocks/pricing#layout-pricing-in-card-view-with-details) block, where you offer your Stripe products/subscriptions to your users.
