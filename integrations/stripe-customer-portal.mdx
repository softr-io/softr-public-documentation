...
<Tip>We've used the **Simple Checkout Form** in our example, but you can use any of the payment blocks integrated with Stripe (e.g. [Pricing block](/building-blocks/pricing#layout-pricing-in-card-view-with-details)).</Tip>
