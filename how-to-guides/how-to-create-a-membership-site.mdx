...
Let's also create another block on the Home Page with a "Start Learning" button (using the [CTA](/building-blocks/static-blocks#cta) block). Using this block, users will be able to navigate to the "Courses" page from Home. This block's visibility should also be set to **Logged in users**. See below.
