...
<Steps>
  <Step title="Creating an app from the template">
    ...
    <Frame>![Notion image](/how-to-guides/images/what-internal-tools-can-you-build-with-softr/image1.gif)</Frame>
  </Step>
  <Step title="Connecting the database">
    ...
    <Frame caption="Connecting the Airtable base">![Connecting the Airtable base](/how-to-guides/images/what-internal-tools-can-you-build-with-softr/image2.gif)</Frame>
  </Step>
